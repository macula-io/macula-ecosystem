...
help() ->
    ...
    io:format("\e[36m│\e[0m                                                               \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mChat\e[0m                                                        \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:join(\"room\").\e[0m          join a room                  \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:say(\"Hello!\").\e[0m        say in current room           \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:say(\"r\",\"msg\").\e[0m      say in specific room          \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:who(\"room\").\e[0m          who's in a room               \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:whisper(Node,\"m\").\e[0m    private message               \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:ping(Node).\e[0m           RTT over mesh                 \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m                                                               \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mErlang Distribution\e[0m  \e[90m(all work over the QUIC relay mesh)\e[0m   \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mnodes().\e[0m                        connected peers               \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mnet_adm:ping(Node).\e[0m             ping a node                   \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mrpc:call(Node, M, F, A).\e[0m        remote function call          \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mgen_server:call({N,Node},m).\e[0m    cross-node gen_server          \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mpg:get_members(pg, Group).\e[0m      cluster-wide pg groups        \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32merlang:monitor(process,{N,Node}).\e[0m  cross-node monitor         \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m                                                               \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[90mAll standard Erlang distribution primitives work\e[0m              \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[90mtransparently — tunneled through QUIC relay mesh.\e[0m             \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m                                                               \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:about().\e[0m              what is MFRM?                \e[36m│\e[0m~n"),
    io:format("\e[36m╰──────────────────────────────────────────────────────────────╯\e[0m~n"),
    io:format("~n"),
    ok.
...
about() ->
    io:format("~n"),
    io:format("\e[36m╭──────────────────────────────────────────────────────────────╮\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mMacula Federated Relay Mesh (MFRM)\e[0m                         \e[36m│\e[0m~n"),
    io:format("\e[36m├──────────────────────────────────────────────────────────────┤\e[0m~n"),
    io:format("\e[36m│\e[0m                                                              \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  A decentralized relay mesh where \e[1mnodes never talk\e[0m            \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mdirectly\e[0m. Every message routes through lightweight           \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  relay servers. Relays are \e[1mstateless\e[0m — they hold no data.     \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  When one dies, nodes reroute in seconds. Automatically.      \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m                                                              \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mTransport\e[0m    QUIC/HTTP3 over UDP — NAT-friendly, 0-RTT      \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mSecurity\e[0m     TLS 1.3, AES-256-GCM per hop                   \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mRouting\e[0m      Full mesh peering + Bloom filter forwarding     \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mDiscovery\e[0m    Geographic IPv6, RTT-ranked relay selection     \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mHealth\e[0m       SWIM protocol for relay liveness                \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mRuntime\e[0m      Erlang/OTP — 2M concurrent processes per node   \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mDist\e[0m         -proto_dist macula — Erlang dist over mesh      \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m                                                              \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mCost\e[0m   A relay is a 4 EUR/month VPS or a Raspberry Pi.      \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m         A data center is a 200M EUR facility.                 \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m         \e[90mYou can't make data centers indestructible.\e[0m           \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m         \e[1mYou can make relays disposable.\e[0m                       \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m                                                              \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[90mOpen source — Apache-2.0 — hex.pm/packages/macula\e[0m           \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[90mmacula.io — github.com/macula-io/macula\e[0m                     \e[36m│\e[0m~n"),
    io:format("\e[36m╰──────────────────────────────────────────────────────────────╯\e[0m~n"),
    io:format("~n"),
    ok.
...
print_banner(RelayUrl) ->
    ...
    io:format("~n"),
    io:format("\e[36m╭──────────────────────────────────────────────────────╮\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[1mMacula Mesh Chat\e[0m                                    \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[90mErlang distribution over Macula mesh using QUIC\e[0m             \e[36m│\e[0m~n"),
    io:format("\e[36m├──────────────────────────────────────────────────────┤\e[0m~n"),
    io:format("\e[36m│\e[0m  Node:      \e[33m~s\e[0m~s\e[36m│\e[0m~n",
              [Node, pad(42 - length(atom_to_list(Node)))]),
    io:format("\e[36m│\e[0m  Relay:     \e[33m~s\e[0m~s\e[36m│\e[0m~n",
              [RelayHost, pad(42 - length(RelayHost))]),
    io:format("\e[36m│\e[0m  IPv6:      \e[90m~s\e[0m~s\e[36m│\e[0m~n",
              [IPv6, pad(42 - length(IPv6))]),
    io:format("\e[36m│\e[0m  Transport: \e[90mQUIC/HTTP3 (UDP 4433, TLS 1.3)\e[0m          \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  Runtime:   \e[90mErlang/OTP ~s │ -proto_dist macula\e[0m~s\e[36m│\e[0m~n",
              [OtpVsn, pad(42 - 28 - length(OtpVsn))]),
    io:format("\e[36m├──────────────────────────────────────────────────────┤\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:say(\"Hello!\").\e[0m    say in current room     \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:who(\"lobby\").\e[0m     who's here?              \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:peers().\e[0m          connected peers          \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:ping(Node).\e[0m       measure RTT over mesh    \e[36m│\e[0m~n"),
    io:format("\e[36m│\e[0m  \e[32mmesh_chat:help().\e[0m           all commands              \e[36m│\e[0m~n"),
    io:format("\e[36m╰──────────────────────────────────────────────────────╯\e[0m~n"),
    io:format("~n").
